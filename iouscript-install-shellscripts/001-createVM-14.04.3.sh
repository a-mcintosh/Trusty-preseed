...
VBoxManage storageattach "coins-$thisEpoch"  --storagectl "SATA Controller" --port 0 --device 0 --type dvddrive --medium /home/amcintosh/projects/coins/$thisEpoch/ubuntu-14.04.3-coins-$thisEpoch-amd64.iso --hotpluggable on
